...
public class Renderer {
	...
	public void renderMesh(GameObject object, Camera camera) {
		...
		GL31.glActiveTexture(GL31.GL_TEXTURE0); // activate the texture unit first before binding texture
		GL31.glBindTexture(GL31.GL_TEXTURE_2D, object.mesh.texture.texture);
		...
		GL31.glTexImage2D(GL31.GL_TEXTURE_2D, 0, GL31.GL_RGB, object.mesh.texture.width, object.mesh.texture.height, 0, GL31.GL_RGB, GL31.GL_UNSIGNED_BYTE, object.mesh.texture.buffer);
		
		//GL31.glPolygonMode(GL31.GL_FRONT_AND_BACK, GL31.GL_LINE); //turn on wireframe
		shader.bind();
//		shader.SetUniform("ourTexture", object.mesh.texture.texture);
